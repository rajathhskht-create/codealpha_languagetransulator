...
User types text → Clicks Translate → Background thread calls Google API → Response parsed (translation + detected language) → UI updated → output shown → Copy/Listen enabled
